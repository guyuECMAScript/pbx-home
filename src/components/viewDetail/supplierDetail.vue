<template>
  <div style="width:100%;overflow-y: auto;margin-bottom: 10px;">
    <div class="table-title-font">
      <el-form ref="form" :model="form" :rules="rules2" label-width="250px" class="demo-ruleForm">
        <!--<el-form-item label="Company Name :"-->
                      <!--prop="buyerName"-->
                      <!--:rules="[-->
                        <!--{ required: true, message: 'Company Name is required.'}-->
                      <!--]">-->
          <!--<el-input maxlength="100" style="width: 500px" v-model.trim="form.buyerName" size="small" :disabled="isAdmin"></el-input>-->
        <!--</el-form-item>-->
        <el-collapse v-model.trim="activeNames" @change="handleChange">
          <el-collapse-item name="1">
            <template slot="title">
              <div class="collspan-title" style="height: 30px;line-height: 30px">
                <div style="width:80%;margin-left: 20px;font-size: 13px">
                  Basic Information
                </div>
              </div>
            </template>
              ...
              <el-col :span="11" style="height: 40px">
                ...
                <span style="font-size: 13px">
                 Seller Code :
                  ...
                  <span class="view-font-color">Sage</span>
                </el-form-item>
              </el-col>
              <el-col :span="12" style="height: 40px">
                ...
                <span style="font-size: 13px">
                 Seller Name :
                  ...
                  <span class="view-font-color">PBXChange</span>
                </el-form-item>
              </el-col>
            </el-row>
              ...
              <el-col :span="12" style="height: 40px">
                ...
                <span style="font-size: 13px">
                 Reg No :
                  ...
                  <span class="view-font-color">21212121</span>
                </el-form-item>
              </el-col>
            </el-row>
              ...
              <el-col :span="11" style="height: 40px">
                ...
                <span style="font-size: 13px">
                 Other Reg No :
                  ...
                  <span class="view-font-color">3123131313</span>
                </el-form-item>
              </el-col>
              <el-col :span="12" style="height: 40px">
                <el-form-item>
                ...
                <span style="font-size: 13px">
                 Source :
                  ...
                  <span class="view-font-color">Local</span>
                </el-form-item>
              </el-col>
            </el-row>
            ...
            <el-row :gutter="24" style="padding-left: 5px;">
              ...
              <el-col :span="12" style="height: 40px">
                ...
                Date Created :
                  ...
                  <span class="view-font-color">2018-01-01</span>
                </el-form-item>
              </el-col>
            </el-row>
              ...
              <el-col :span="11" style="height: 40px">
                ...
                <span style="font-size: 13px">
                 Live Date:
                  ...
                  <span class="view-font-color">2018-01-0</span>
                </el-form-item>
              </el-col>
              <el-col :span="12" style="height: 40px">
                <el-form-item>
              ...
              <el-col :span="11" style="height: 40px">
                ...
                <span style="font-size: 13px">
                 Business Types :
                  ...
                  <span class="view-font-color">B2B retail</span>
                </el-form-item>
              </el-col>
              <el-col :span="12" style="height: 40px">
...
<style scoped>
  table,table tr th, table tr td { border:1px solid #c9ccd3; }
