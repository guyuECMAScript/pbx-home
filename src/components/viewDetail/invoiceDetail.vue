<template>
  <div style="width:100%;min-height:400px;overflow-y: auto;margin-bottom: 10px;">
              ...
              <el-col :span="11" style="height: 40px">
                ...
                <span style="font-size: 13px">
                 Invoice No :
                  ...
                  <span class="view-font-color">1233333221111</span>
                </el-form-item>
              </el-col>
              ...
              <el-col :span="11" style="height: 40px">
                ...
                <span style="font-size: 13px">
                 PDF
                  ...
                  <span class="font-blue mouse-hand">Show PDF</span>
                </el-form-item>
              </el-col>
